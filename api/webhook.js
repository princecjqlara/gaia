...
export default async function handler(req, res) {
  ...
  // TEST CHAT: POST ?action=test_chat
  // Lets admin test the AI chatbot without sending to Facebook
  if (req.method === "POST" && req.body?.action === "test_chat") {
    try {
      ...
      // Build a prompt using the same structure as the real chatbot
      const systemPrompt = config?.system_prompt || "You are a friendly AI sales assistant for a business. Be helpful, professional, and concise.";
      ...
      console.error("[WEBHOOK] Test chat error:", err);
